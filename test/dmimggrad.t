...
# !!4
alltests="test_laplace test_roberts test_prewitt test_sobel test_robison test_kirsch"
# "short" test to run
# !!5
shortlist="$alltests"
...
do
  ...
  case ${testid} in
    # !!6
    test_laplace ) test1_string="dmimggrad infile=$INDIR/img.fits outfile="${outfile}" gradient=laplace value=mag clob+"
            ;;

    test_roberts ) test1_string="dmimggrad infile=$INDIR/img.fits outfile="${outfile}" gradient=roberts value=mag clob+"
            ;;
    test_prewitt ) test1_string="dmimggrad infile=$INDIR/img.fits outfile="${outfile}" gradient=prewitt value=y clob+"
            ;;
    test_sobel ) test1_string="dmimggrad infile=$INDIR/img.fits outfile="${outfile}" gradient=sobel value=x clob+"
            ;;
    test_robison ) test1_string="dmimggrad infile=$INDIR/img.fits outfile="${outfile}" gradient=robison value=mag clob+"
            ;;
    test_kirsch ) test1_string="dmimggrad infile=$INDIR/img.fits outfile="${outfile}" gradient=kirsch value=ang clob+"
            ;;
